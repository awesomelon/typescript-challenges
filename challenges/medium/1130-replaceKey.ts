...
//   [K in keyof U as K extends T ? K : never]: K extends keyof Y
//     ? Y[K]
//     : K extends keyof U
//       ? U[K]
//       : never;
...
type ReplaceKeys<U, T extends PropertyKey, Y> = U extends unknown
  ? {
      [K in keyof U]: K extends T ? (K extends keyof Y ? Y[K] : never) : U[K];
    }
  : never;

type D = ReplaceKeys<Nodes, "name" | "flag", { name: number; flag: string }>;
